...
#Getting more details For more details, please see the MPGE reference manual. For any question, please send an email to [statgen.arunabha\@gmail.com](mailto:statgen.arunabha@gmail.com){.email} or [tanushree.haldar\@gmail.com](mailto:tanushree.haldar@gmail.com){.email}. Also, you can see our manuscript for more details related to the main method: A Majumdar, KS Burch, T Haldar, S Sankararaman, B Pasaniuc, WJ Gauderman, JS Witte. A two-step approach to testing overall effect of gene-environment interaction for multiple phenotypes. Bioinformatics 36, no. 24 (2020): 5640-5648.

<!-- badges: start -->

[![Travis build status](https://app.travis-ci.com/ArunabhaCodes/MPGE.svg?branch=master)](https://app.travis-ci.com/ArunabhaCodes/MPGE)
