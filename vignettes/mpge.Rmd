...
vignette: >
  %\VignetteIndexEntry{MPGE package: A two-step approach to testing overall effect of gene-environment interaction for multiple phenotypes}
...
```{r example_mv_G_GE, collapse = TRUE}
